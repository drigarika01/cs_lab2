...
namespace ConsoleApp1
{
    class Program
    {
        ...
        {
            Console.WriteLine("Ваше перше число (у межах -127 до +127): ");
            float numb1 = float.Parse(Console.ReadLine());
            Console.WriteLine("Ваше друге число (у межах -127 до +127): ");
        ...
        static void Calculate(float numb1, float numb2)
        {
            ...
            Console.WriteLine("Підраховуємо: {0} + {1} ", numb1, numb2);
