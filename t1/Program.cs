    ...
    public class Division_as_is
    {
        ...
        public int[] Division(int first, int second)
        {
            ...
            for (int i = 0; i < dividend.Length + 1; i++)
            {
                ...
                Console.WriteLine("Ділюване: " + Print(dividend));
                Console.WriteLine("Залишок: " + Print(reminder));
                Console.WriteLine("Дільник: " + Print(divisor));
                Console.WriteLine("Частка: " + Print(quotient));
                ...
                Console.WriteLine("Додавання без знаку");

                if (reminder[0] == 0)
                {
                    quotient = ShiftLeft(quotient);
                    Console.WriteLine("Здвиг вправо");
                }
                else
                {
                    ...
                    Console.WriteLine("Здвиг вліво без знак");
                }
            ...
            Console.WriteLine();
            Console.WriteLine("Ділюване перше число :" + first.ToString());
            Console.WriteLine("Дільник друге число   :" + second.ToString());
